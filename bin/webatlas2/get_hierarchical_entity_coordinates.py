...
def process(output_path, entity_type, project_annotations_path, zarr_anndata_paths):
    if not output_path or not entity_type or not project_annotations_path or not zarr_anndata_paths:
        print("Please provide the output path, "
              " the hierarchical entity type, " +
